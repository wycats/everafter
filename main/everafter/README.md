...
This is saying that the system has a single parameter named `number`, and its TypeScript type is `number`.
...
1. the reactive atoms of the data structure
2. an output data structure
3. a cursor into the data structure
4. regions of the data structure

When talking about an array of numbers, here's how those concepts map:

1. the **reactive atoms** are reactive numbers
2. the **output data structure** is an array of numbers
3. the **cursor into the data structure** is an offset into the data structure
4. a **region of the data structure** is a starting and ending offset into the array

> Note: In practice, cursors and regions need to take the possibility of preceding blocks
> changing, and therefore simple offsets aren't sufficient. Take a look at `docs/array.md`
> for a fuller picture of how that works.
